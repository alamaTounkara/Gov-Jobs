...
public class UserSettingsAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Log.d("account", "position: " + position);
...
//        while(jobs.hasNext())
//        {
//            Map.Entry e = jobs.next();
//            Integer key = (Integer) e.getKey();
//            String value = jobs.getValue();
//            System.out.println(key + " " + value);
//        }
//
//        final Map.Entry<Integer,String> entry=  temp.n;
            ...
            mMyViewHolder.image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   dataSource.remove(position);
                    ...
                    Log.d("AccountManger", "deleteJob: " + c);
                    //mAccountManger.deleteJob(mUserId, position);
                }
            });
            Log.d("json conversion", obj.toString());
