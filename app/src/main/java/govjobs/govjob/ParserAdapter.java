    ...
    */
    public ArrayList<HashMap<String, String>> processJSON(StringBuffer stringBuffer) {
        ...
        try {
            ...
            Log.d("mem", "totalJobs" +mJotalJobs);
           ...
           // Log.d("result", "" + jsonArray.getJSONObject(0).toString());
            ...
            Log.d("result", "currentValue 1: " + jsonArray.length());
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                Log.d("result", "" + currentValue);
                Log.d("result", "currentValue: " + subJsonObject.getString(JOB_WORK_SCHEDULE));
               Log.d("result", "currentValue 2: " + subJsonObject.getString(JOB_POSITION_TITLE));
...
//
//        //this JsonArray will be passed to joblist activity to send via intent to another another
//        HashMap<String, String> jobTotal = new HashMap<String, String>();
//        jobTotal.put(JOB_TOTAL, totalJobs);
//
//        results.add(jobTotal);
        return results;
